...
| Pythagorean Three-Body Problem | Burrau's 1913 test case: masses 3, 4, and 5 at rest at the vertices of a 3-4-5 right triangle. Unlike every other preset above, nothing here is tuned into a stable or periodic path — the slightest change to the starting conditions sends the bodies down a completely different one. What plays out is a chaotic dance of repeated close encounters, typically ending (in this simulation's softened physics) with two of the bodies merging. |
